...
if useParallelCheck
    try
        ...
        % If there is an issue running the tests in parallel, attempt to re-run in single threading
        disp(repelem('-', 30))
        disp(E);
        disp(repelem('-', 30))
...
% 
% The diagnostic output cuts output past the kewyord "Framework Diagnostics", which means the tester is responsible for 
